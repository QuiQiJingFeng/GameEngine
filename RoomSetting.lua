...
RoomSetting.GamePlayName = {}
local keys = table.keys(RoomSetting.GamePlayCode)
for _,key in ipairs(keys) do
    local name = RoomSetting.GamePlayCode[key]
    RoomSetting.GamePlayName[name] = key
end

RoomSetting.CONVERT_PLAYER_NUM = {
    PLAYER_TWO = 2,
    PLAYER_THREE = 3,
    PLAYER_FOUR = 4
}

RoomSetting.CONVERT_ROUND_NUM = {
